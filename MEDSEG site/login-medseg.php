    ...
    <div class="col-lg-6 col-md-8 col-sm-10 col-12">
      <div class="form">
        <form action="medseg-login.php" method="POST" class="p-4 shadow bg-white rounded-4">
          <h2 class="mb-4 text-primary text-center fw-bold">Login</h2>

          <!-- Campo de Acesso Unificado -->
<div class="mb-3">
  <label for="login" class="form-label">Login</label>
  <div class="input-group">
    <!-- Ícone de usuário que serve para ambos -->
  ...
  <small class="text-muted">Utilize seu nome de usuário ou identificador cadastrado.</small>
</div>
...
<div class="mb-3">
  ...
  <div class="input-group">
    ...
    <span class="input-group-text toggle-password" style="cursor: pointer;" data-target="senha">
